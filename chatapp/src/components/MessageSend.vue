<template>
  <div class="flex flex-col bg-gray-100 border-t border-gray-200 relative bottom-0">
    ...
    <button @click="sendMessage" class="absolute bottom-4 right-4 p-1 text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none" data-testid="send-message-button">
      <svg
